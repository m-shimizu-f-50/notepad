# IT用語
```
1.UI 2.ロジック 3.リファクタリング 4.アルゴリズム 5.サーバーとクライアント　6.OS 7.リーダブルコード 8.コーディング 9.フレームワーク 10.ローカル環境 11.仮想化 12.フロントエンドとバックエンド 13.アーキテクスチャ 14.オブジェクト指向 15.パソコンのスペック 16.ブラウザの種類 17.脆弱性 18.ツール
